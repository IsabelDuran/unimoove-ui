...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UnimooveApi.PaginationInfo();
  });
  ...
  describe('PaginationInfo', function() {
    it('should create an instance of PaginationInfo', function() {
      // uncomment below and update the code to test PaginationInfo
      //var instane = new UnimooveApi.PaginationInfo();
      //expect(instance).to.be.a(UnimooveApi.PaginationInfo);
    });
