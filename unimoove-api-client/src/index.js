...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define([
      'ApiClient',
      'model/CarBrandChangeRequest',
      'model/CarCreationRequest',
      'model/CarModelChangeRequest',
      'model/CarResponse',
      'model/LoginRequest',
      'model/LoginResponse',
      'model/PaginationInfo',
      'model/PlaceCategoryChangeRequest',
      'model/PlaceCreationRequest',
      'model/PlaceIdChangeRequest',
      'model/PlaceNameChangeRequest',
      'model/PlacePaginatedResponse',
      'model/PlaceResponse',
      'model/ReservationCreationRequest',
      'model/ReservationPaginatedResponse',
      'model/ReservationResponse',
      'model/TripArrivalPlaceChangeRequest',
      'model/TripCreationRequest',
      'model/TripDepartureDateTimeChangeRequest',
      'model/TripDeparturePlaceChangeRequest',
      'model/TripNumberAvailableSeatsChangeRequest',
      'model/TripPaginatedResponse',
      'model/TripReservationResponse',
      'model/TripResponse',
      'model/UserBirthdateChangeRequest',
      'model/UserEmailChangeRequest',
      'model/UserGenderChangeRequest',
      'model/UserLastnameChangeRequest',
      'model/UserNameChangeRequest',
      'model/UserPaginatedResponse',
      'model/UserPasswordChangeRequest',
      'model/UserRegistrationRequest',
      'model/UserResponse',
      'model/UserRoleChangeRequest',
      'model/UserUsernameChangeRequest',
    ...
    module.exports = factory(
      require('./ApiClient'),
      require('./model/CarBrandChangeRequest'),
      require('./model/CarCreationRequest'),
      require('./model/CarModelChangeRequest'),
      require('./model/CarResponse'),
      require('./model/LoginRequest'),
      require('./model/LoginResponse'),
      require('./model/PaginationInfo'),
      require('./model/PlaceCategoryChangeRequest'),
      require('./model/PlaceCreationRequest'),
      require('./model/PlaceIdChangeRequest'),
      require('./model/PlaceNameChangeRequest'),
      require('./model/PlacePaginatedResponse'),
      require('./model/PlaceResponse'),
      require('./model/ReservationCreationRequest'),
      require('./model/ReservationPaginatedResponse'),
      require('./model/ReservationResponse'),
      require('./model/TripArrivalPlaceChangeRequest'),
      require('./model/TripCreationRequest'),
      require('./model/TripDepartureDateTimeChangeRequest'),
      require('./model/TripDeparturePlaceChangeRequest'),
      require('./model/TripNumberAvailableSeatsChangeRequest'),
      require('./model/TripPaginatedResponse'),
      require('./model/TripReservationResponse'),
      require('./model/TripResponse'),
      require('./model/UserBirthdateChangeRequest'),
      require('./model/UserEmailChangeRequest'),
      require('./model/UserGenderChangeRequest'),
      require('./model/UserLastnameChangeRequest'),
      require('./model/UserNameChangeRequest'),
      require('./model/UserPaginatedResponse'),
      require('./model/UserPasswordChangeRequest'),
      require('./model/UserRegistrationRequest'),
      require('./model/UserResponse'),
      require('./model/UserRoleChangeRequest'),
      require('./model/UserUsernameChangeRequest'),
      require('./api/AuthenticationApi'),
      require('./api/CarsApi'),
      require('./api/PlacesApi'),
      require('./api/ReservationsApi'),
      require('./api/TripsApi'),
