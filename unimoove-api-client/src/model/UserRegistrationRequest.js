...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.UnimooveApi.UserRegistrationRequest = factory(root.UnimooveApi.ApiClient);
  }
   ...
   */
  var exports = function(birthdate, email, gender, lastname, name, password, role, username) {
    var _this = this;
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('role')) {
        obj['role'] = ApiClient.convertToType(data['role'], 'Integer');
      }
