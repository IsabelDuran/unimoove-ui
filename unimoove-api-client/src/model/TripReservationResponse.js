...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.UnimooveApi.TripReservationResponse = factory(root.UnimooveApi.ApiClient);
  }
  ...
  /**
   * The TripReservationResponse model module.
   * @module model/TripReservationResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TripReservationResponse</code>.
   * @alias module:model/TripReservationResponse
   * @class
   ...
   * @param state {Integer} 
   */
  var exports = function(arrivalPlace, departureDateTime, departurePlace, id, price, state) {
    var _this = this;
  ...
  /**
   * Constructs a <code>TripReservationResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TripReservationResponse} obj Optional instance to populate.
   * @return {module:model/TripReservationResponse} The populated <code>TripReservationResponse</code> instance.
   */
